...
import com.hlg.aap.model.dto.question.*;
import com.hlg.aap.model.entity.App;
import com.hlg.aap.model.entity.Question;
import com.hlg.aap.model.entity.User;
import com.hlg.aap.model.vo.QuestionVO;
import com.hlg.aap.service.AppService;
import com.hlg.aap.service.QuestionService;
...
public class QuestionController {
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        if (!app.getUserId().equals(loginUser.getId()) && !userService.isAdmin(request)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "仅本人或管理员可在该应用中增加题目");
        }
