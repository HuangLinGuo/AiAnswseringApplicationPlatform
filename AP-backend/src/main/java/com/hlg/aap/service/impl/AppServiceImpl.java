...
import com.hlg.aap.mapper.AppMapper;
import com.hlg.aap.model.dto.app.AppQueryRequest;
import com.hlg.aap.model.entity.App;
import com.hlg.aap.model.entity.User;
import com.hlg.aap.model.enums.AppScoringStrategyEnum;
import com.hlg.aap.model.enums.AppTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appDesc)) {
            ThrowUtils.throwIf(appDesc.length() > 100, ErrorCode.PARAMS_ERROR, "应用描述过长");
        }
