...
import com.hlg.aap.mapper.QuestionMapper;
import com.hlg.aap.model.dto.question.QuestionQueryRequest;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(ObjectUtils.isEmpty(appId) || appId <= 0, ErrorCode.PARAMS_ERROR,"appId不能为空");
            //ThrowUtils.throwIf(ObjectUtils.isEmpty(userId) || userId <= 0, ErrorCode.PARAMS_ERROR,"userId不能为空");
        }
        // 修改数据时，有参数则校验
        //补充校验规则
